...
#define LDC_CLASS_MEMBER_TEST(QUALIFIERS, MEMBER, PROTO) \
    struct LDC_CLASS_MEMBER_TEST_##MEMBER { \
        ...
        struct CHECK { \
            ...
            \
            template<typename LDC_U, \
                     std::enable_if_t<std::is_same_v<LDC_PROTO, \
    ...
    static constexpr bool LDC_CLASS_MEMBER_TEST_VALUE_##MEMBER = \
        sizeof(LDC_CLASS_MEMBER_TEST_##MEMBER::template CHECK<PROTO>::template test<LDC_T>(std::declval<int>())) == sizeof(uint16_t)

#define LDC_CLASS_MEMBER_TEST_VALUE(TYPENAME, MEMBER) LDC_CLASS_MEMBER_TEST_VALUE_##MEMBER<TYPENAME>
#define LDC_CLASS_MEMBER_TEST_VALUE_AUTONAME(TYPENAME, QUALIFIERS, MEMBER, PROTO) \
    LDC_CLASS_MEMBER_TEST(QUALIFIERS, MEMBER, PROTO); \
    constexpr static bool has_##MEMBER= LDC_CLASS_MEMBER_TEST_VALUE(TYPENAME, MEMBER)
...
#define LDC_CLASS_STATIC_MEMBER_TEST(MEMBER, PROTO) \
    ...
    static constexpr bool LDC_CLASS_STATIC_MEMBER_TEST_VALUE_##MEMBER = \
        sizeof(LDC_CLASS_STATIC_MEMBER_TEST_##MEMBER::template CHECK<PROTO>::template test<LDC_T>(std::declval<int>())) == sizeof(uint16_t)

#define LDC_CLASS_STATIC_MEMBER_TEST_VALUE(TYPENAME, MEMBER) LDC_CLASS_STATIC_MEMBER_TEST_VALUE_##MEMBER<TYPENAME>
#define LDC_CLASS_STATIC_MEMBER_TEST_VALUE_AUTONAME(TYPENAME, MEMBER, PROTO) \
    LDC_CLASS_STATIC_MEMBER_TEST(MEMBER, PROTO); \
    constexpr static bool has_##MEMBER= LDC_CLASS_STATIC_MEMBER_TEST_VALUE(TYPENAME, MEMBER)
